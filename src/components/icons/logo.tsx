...
export function LogoMark({ w = 38, h = 38 }: LogoMarkProps) {
  return (
    <strong className="mx-1 flex items-center gap-2 text-xl font-semibold text-zinc-900">
      <svg
        ...
        viewBox="0 0 38 38"
      >
        <g filter="url(#filter0_dd_404_200)">
          <g clipPath="url(#clip0_404_200)">
            ...
            <rect
              ...
              x="3"
              y="2"
              fill="url(#paint0_linear_404_200)"
              rx="8"
            ></rect>
            <path
              fill="#D0D5DD"
            ...
            ></path>
            <g filter="url(#filter1_dd_404_200)">
              <circle
                cx="19"
                cy="18"
                r="8"
                fill="url(#paint1_linear_404_200)"
              ></circle>
            </g>
            <g filter="url(#filter2_b_404_200)">
              <path
                fill="#fff"
                fillOpacity="0.2"
        ...
        <defs>
          ...
          >
            ...
            <feBlend
              ...
              result="effect1_dropShadow_404_200"
            ></feBlend>
            <feColorMatrix
              in="SourceAlpha"
              result="hardAlpha"
            ...
            <feBlend
              in2="effect1_dropShadow_404_200"
              result="effect2_dropShadow_404_200"
            ></feBlend>
            <feBlend
              in="SourceGraphic"
              in2="effect2_dropShadow_404_200"
              result="shape"
            ></feBlend>
          </filter>
          <filter
            id="filter1_dd_404_200"
            width="22"
            height="22"
            x="8"
            y="8"
          ...
          >
            ...
            <feComposite
              in2="SourceAlpha"
              operator="in"
              result="effect1_backgroundBlur_404_200"
            ></feComposite>
            <feBlend
              in="SourceGraphic"
              in2="effect1_backgroundBlur_404_200"
              result="shape"
            ></feBlend>
          </filter>
          <linearGradient
            id="paint0_linear_404_200"
            x1="19"
            x2="19"
            y1="2"
            y2="34"
